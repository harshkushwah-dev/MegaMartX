...
const ContactMain = () => {
  return (
    <div className="demo-one">
      {/* Contact Banner */}
      <div className="rts-contact-main-wrapper-banner bg_image" style={{backgroundImage:'url(https://ekomart-nextjs.vercel.app/assets/images/contact/01.jpg)'}} >
                ...
                <div className="row">
                  ...
                  <div className="col-lg-5 mt_md--30 mt_sm--30">
                    <div className="thumbnail-area">
                      <img src="https://ekomart-nextjs.vercel.app/assets/images/contact/02.jpg" alt="contact_form" />
                    </div>
                  </div>
                </div>
              </div>
